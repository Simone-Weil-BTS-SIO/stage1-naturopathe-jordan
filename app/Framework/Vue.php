...
class Vue {
    ...
    public function generer($donnees) {
        ...
        $styles = (isset($this->styles)) ? $this->styles : [];
	    $titre = (isset($this->titre)) ? $this->titre : "Naturopathie";
        // Génération du gabarit commun utilisant la partie spécifique
        $vue = $this->genererFichier(SITE_ROOT.'Vue/gabarit.php',
                array('titre' => $titre, 'contenu' => $contenu, 'racineWeb' => $racineWeb, 'scripts' => $scripts, 'styles' => $styles));
